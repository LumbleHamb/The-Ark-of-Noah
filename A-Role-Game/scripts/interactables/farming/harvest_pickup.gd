...
static var _empty_texture: Texture2D = preload("res://assets/ui/Item slots/Slot_01_Empty.png")
...
static func spawn(stack: ItemStack, parent: Node, world_position: Vector2) -> HarvestPickup:
	var pickup_scene: PackedScene = load("res://scenes/interactables/farming/harvest_pickup.tscn") as PackedScene
