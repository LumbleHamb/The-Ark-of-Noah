...
## Inventory page — shows collected items in a grid of slots.
...
## Creates the visual slot grid of empty slots.
...
## Called when inventory data changes. Placeholder for future functionality.
